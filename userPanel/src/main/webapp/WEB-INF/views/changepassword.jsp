                    ...
                    <div class="col-lg-12">
                        <div class="w-50 m-auto w-sm-100">
                            <div class="login-form">
								...
								modelAttribute="cpass" action="/userPanel/user/change" class="icon-form">
								...
								<center>
                                  <div>
                                       ...
                                       <a href="/userPanel/user/home"><button type="submit" class="btn btn-primary mt-3">Reset</button></a>
